	program harmonic oscillator hamiltonian matrix
	implicit real*8(a-h, o-z)
	character(len=*), parameter :: file2 = 'HOVmatrix.res'
     +               , file3 = 'HOTmatrix.res', file4 = 'HOHmatrix.res'
	...
	allocate (h(m,0:n), psin1(m), psin2(m), psin2_(m), factv(0:n)
     +      , fv(m), ft(m), V(0:n,0:n), T(0:n,0:n), HHO(0:n,0:n), x(m))
	...
	do n1 = 0, n ! to print matrix rows
	...
	! MATRIX ELEMENTS
	!______________________________________________________________
	  V(n1,n2) = simpson(fv, xi, xf, m) ! <n1|V|n2>
	  T(n1,n2) = simpson(ft, xi, xf, m) ! <n1|T|n2>
	  HHO(n1,n2) = T(n1,n2) + V(n1,n2)
	 enddo
	!______________________________________________________________
	! PRINTING OUTPUT FILE
	!______________________________________________________________
	write(2,*) (V(n1,n2), n2 = 0, n)
	write(3,*) (T(n1,n2), n2 = 0, n)
	write(4,*) (HHO(n1,n2), n2 = 0, n)
	enddo
	end program harmonic oscillator hamiltonian matrix
